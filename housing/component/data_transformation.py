...
from housing.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact, DataIngestionArtifact
from housing.exception import HousingException
from housing.logger import logging
from housing.util.util import read_yaml_file
from housing.constant import *
from housing.util.util import save_numpy_array_data, save_object
...
class DataTransformation:
    ...
    def load_data(file_path:str, schema_file_path:str) -> pd.DataFrame:
        """
        Make sure the data we read is as per schema.
        Validates and converts if necessary.
        """
        try:
    ...
    def get_data_transformer_object(self)->ColumnTransformer:
        try:
            ...
            target_column = dataset_schema[SCHEMA_FILE_TARGET_COLUMNS]

            numerical_columns = []
            categorical_columns = []

            all_columns = dataset_schema[SCHEMA_FILE_COLUMNS_KEY]
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            target_column_name = schema[SCHEMA_FILE_TARGET_COLUMNS]
